...
print("\nLogistic Regression Test Accuracy:", accuracy_score(y_test, y_test_pred_logreg))
...
gb.fit(X_train_imputed, y_train_resampled)

y_val_pred_gb = gb.predict(X_val_imputed)

print("\nGradient Boosting Validation Accuracy:", accuracy_score(y_val, y_val_pred_gb))
...
test_predictions = gb.predict(X_test_imputed)
...
test_df.to_csv("predicted_landcover_2024_300m_gb.csv", index=False)

print("\nSaved predictions to predicted_landcover_2024_300m_gb.csv")
